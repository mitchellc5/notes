...
class Snap(BaseInterface, Device):
    actual_position = Cpt(EpicsSignal, 'DCCM:SWITCH:MMS:TH2.RBV')
    encoder_count = Cpt(EpicsSignal, 'DCCM:SWITCH:MMS:TH2:PLC:nEncoderCount_RBV')
...
file1 = open("hard_notes_th2.txt", "a")
