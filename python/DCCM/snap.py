...
class Snap(BaseInterface, Device):
    actual_position = Cpt(EpicsSignal, 'DCCM:SWITCH:MMS:TH1.RBV')
    encoder_count = Cpt(EpicsSignal, 'DCCM:SWITCH:MMS:TH1:PLC:nEncoderCount_RBV')
...
file1 = open("hard_notes_TH1.txt", "a")
